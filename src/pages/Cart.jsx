        ...
        <div>
          ...
          <div>
              ...
              {cartItem.map((item, index) => {
                return (
                  ...
                  >
                    ...
                    <div className="text-red-500 cursor-pointer hover:text-red-600 transition-all hover:shadow-2xl p-2 rounded-full">
            ...
            <div className="grid grid-cols-2 gap-10 ">
              <div className="bg-gray-100 rounded-md p-5 mt-5 space-y-2">
                ...
                <div className="flex justify-end gap-2 mt-5">
                  <button
                    onClick={() => navigate(-1)}
                    className="bg-white text-red-500 py-2 px-4 rounded-md hover:bg-red-50 transition-all duration-300 cursor-pointer"
                  >
                    Back
                  </button>
                  <button
              ...
              {/* Order Summary */}
              <div className="bg-white rounded-md p-5 mt-5 space-y-2 border border-gray-200 shadow-xl h-max">
